...
test.serial('AddressController#createAddress', (t) => {
  const result = addressController.createAddress(userId, address);
...
test.serial('AdressController#updateAddress', (t) => {
  const result = addressController.updateAddress(id, address);
